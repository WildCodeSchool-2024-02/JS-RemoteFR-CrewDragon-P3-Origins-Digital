...
(2, 6, 'https://www.youtube.com/watch?v=NBElzosmpYI', 'Qui est la personnalité Française préférée des Américains?', 'J’ai demandé aux Américains qui sont leurs célébrités françaises préférées. Que penses-tu de leurs réponses?', '2024-04-26', '11:08', 2);


-- Catégorie Tech
INSERT INTO videos (categories_id, souscats_id, url, title, description, date, duree, abonnementsid) VALUES
(3, 7, 'https://www.youtube.com/watch?v=mkvfbr5Atfc', 'Pourquoi les carrières Esport sont courtes ?', 'Rare sont les joueurs professionnels d\'esport à rester plus de quelques années sur le devant de la scène. Pourquoi les carrières sont si courtes ? Est-ce seulement une question de réflexe et de temps de réaction ? C\'est les questions qu\'on se pose aujourd\'hui.', '2024-06-11', '09:54', 1),
(3, 7, 'https://www.youtube.com/watch?v=KVYvLvvU9iU', 'G2 vs SK, quel BANGER entre Caps et Nisqy ! | LEC Summer 2024', 'Suivez la compétition sur OTP LoL !', '2024-06-10', '01:03:25', 1),
(3, 7, 'https://www.youtube.com/watch?v=HHaJiF55gIw', 'Grand Final! Sentinels vs LOUD | Champions Tour 2024: Americas Kickoff 2024', 'Subscribe for More Professional Valorant Content, Road to 200k Subscribers.', '2024-03-04', '03:54:47', 2),
(3, 8, 'https://www.youtube.com/watch?v=3LP3URouGAE', 'LES NEWS CITY OF THE WOLVES - BlaBlaSton #38', 'On discute des nouveaux persos annoncés de CotW et des commentaires sur l\'avenir de SNK / KOF et FATTAL FURY par SNK au SGF. Quelques nouveaux replays présentés aussi en fin de BlaBlaSton, annonce sur les prochains tournois et attente sur 2XKO', '2024-06-11', '45:38', 1),
(3, 8, 'https://www.youtube.com/watch?v=Gr78-FI1EVU', 'TOUTE UNE ÉPOQUE | Metal Slug Tactics (découverte)', 'Découverte de la démo Steam Neo Fest de Metal Slug Tactics, un spinoff tactical RPG de cette série mythique avec une fidélité visuelle/sonore à l\'œuvre originale bluffante !', '2024-06-11', '40:11', 2),
(3, 8, 'https://www.youtube.com/watch?v=UBpW9ZmcfhA', 'STAR WARS OUTLAWS : J\'y ai JOUÉ pendant 1 HEURE en AVANT-PREMIÈRE 🔥 Mon 1ER TEST', 'Subscribe for More Professional Valorant Content, Road to 200k Subscribers.', '2024-06-11', '14:53', 2),
